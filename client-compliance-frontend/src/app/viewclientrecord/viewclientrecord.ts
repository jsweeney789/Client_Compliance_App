...
@Component({
  ...
  imports: [TableModule, InputTextModule, TagModule, FormsModule, CommonModule, RouterModule, DialogModule, 
    ...
    SelectModule],
  templateUrl: './viewclientrecord.html',
  styleUrl: './viewclientrecord.css',
})
...
clienttypes = [
  ...
  openClient(client: ClientRecord) {
  this.selectedClient = client;
  this.showDialog = true;
}

openEdit(client: ClientRecord) {
...
saveClient() {
  ...
  this.clientservice.updateClientRecord(this.editClient)
    .subscribe({
      next: () => {
